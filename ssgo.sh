...
Set(){
 ...
 ${Green_font_prefix}3.${Font_color_suffix}  修改 加密
 ${Green_font_prefix}4.${Font_color_suffix}  修改 详细日志模式
...
# 	echo && echo -e "  Shadowsocks-Go GoGoGo ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}"
# 	echo "
